...
<div class="line-height" >
	<p class="line-height" style="font-size: 48px;text-align: center;font-family: 'Century Gothic'; font-weight: 100;margin-left: -10%; " >FUSION</p>
</div>
</div>
 ...
 <!--  <ol class="carousel-indicators">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/Fusion.jpg" style="width: 1440px;height: 450px;"
        alt="Third slide">
    </div>
    <!--/First slide-->
    <!--Second slide-->
...
<div class="container-fluid lisliders" >
	<ul class="list-group">
	  <li class="list-group-item line-heights">A very smooth surface finish</li>
	  <li class="list-group-item line-heights">The ability to cast complex shapes with thin walls</li>
	  <li class="list-group-item line-heights">The capacity for forming large parts with less expense</li>
	  <li class="list-group-item line-heights">large parts with less expense processes, such as investment casting</li>
	</ul>
</div>
    ...
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
      ...
      <div class="card collection-card z-depth-1-half">
        ...
        <div class="view zoom" style="height: 250px;">
          <img src="img/goldfirst-1.jpg" class="img-fluid animated flipInY"
            alt="">
  ...
  <div class="row">
    <div class="col-md-12">
       <div class="modal-header" style="background-color: #999999;">
        <h5 class="modal-title" id="exampleModalLabel" style="color: #fff;">Red Trousers</h5>
    ...
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-4">
      ...
      <div class="card collection-card z-depth-1-half">
        <!-- Card image -->
         <div class="view zoom" style="height: 150px;">
          <a href="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/8.jpg"  data-lightbox="roadtrip" data-title="Beauty Scenery 1">
          <img src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/8.jpg" class="img-fluid"
            alt="">
          </a>
          <div class="stripe light">
    ...
    <div class="col-lg-3 col-md-6 mb-md-0 mb-4">
      ...
      <div class="card collection-card z-depth-1-half">
        <!-- Card image -->
        <div class="view zoom" style="height: 150px;">
          <a href="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/9.jpg"  data-lightbox="roadtrip" data-title="Beauty Scenery 1">
          <img src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/9.jpg" class="img-fluid"
            alt="">
          </a>
          <div class="stripe dark">

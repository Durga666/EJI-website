...
<head>
  ...
  <title>Emerald Jewel Industry India Ltd | Request Collection</title>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center align-items-center d-flex text-center ">
          <div class="col-12 col-md-8 h-50 pt-5">
            <h1 class="text-light pb-3 pt-5">View Collection</h1>
            <p class="text-light"> To view the entire collection, please leave in your information, our team will send the “world of emerald designs at the earliest.”</p>
          </div>
        </div>
      </div>
    </section>
